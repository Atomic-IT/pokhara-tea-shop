...
export const messages = {
  en: {
    ...
    place: 'Pokhara, Nepal',
    brandMain: 'Healthy',
    brandSub: 'Organic Teas',
    tagline: 'From Local Hands With Honest Hearts',
    heroSupport:
      'We collect directly from villagers and promote local products — empowering communities and preserving tradition.',
    exploreProducts: 'Explore products',
    talkWithUs: 'Talk with us',
    whatsapp: 'WhatsApp',
    valuesEyebrow: 'What we stand for',
    valuesHeading: 'Good for people, nature, and you',
    valuesLead:
      'Every jar, leaf, and spice we share carries the same promise printed on our card: fair trade, pure goodness, real impact.',
    valuePeopleTitle: 'Good for People',
    valuePeopleText:
      'We collect directly from villagers, supporting livelihoods and keeping local traditions alive.',
    valueNatureTitle: 'Good for Nature',
    valueNatureText:
      'Organic, fair-trade sourcing that respects the Himalayan landscape and its seasons.',
    valueYouTitle: 'Good for You',
    valueYouText:
      'Authentic, high-quality products chosen for purity, taste, and everyday wellness.',
    productsEyebrow: 'Our premium products',
    productsHeading: 'Himalayan treasures, honestly sourced',
    productsLead:
      'From tea gardens to mountain resins — authentic local goods, and more treasures from the communities we work with.',
    readMore: 'Read more',
    moreTreasures: '& more local treasures',
    askWhatsapp: 'Ask on WhatsApp',
    close: 'Close',
    missionEyebrow: 'Directly from villagers',
    missionHeading: 'Fair trade with honest hearts',
    missionLead:
      'We work directly with local communities to bring you authentic, high-quality products while supporting their livelihood.',
    contactEyebrow: 'Say hello',
    contactHeading: 'Visit us in Pokhara — or write anytime',
    contactLead:
      'Curious about a product, wholesale, or a tasting? We are happy to share what is fresh from the villages.',
    phone: 'Phone',
    email: 'Email',
  ...
  ne: {
    ...
    navStory: 'हाम्रो कथा',
    navContact: 'सम्पर्क',
    navCta: 'सम्पर्क गर्नुहोस्',
    openMenu: 'मेनु खोल्नुहोस्',
    closeMenu: 'मेनु बन्द गर्नुहोस्',
    place: 'पोखरा, नेपाल',
    brandMain: 'Healthy',
    brandSub: 'Organic Teas',
    tagline: 'स्थानीय हात र इमानदार हृदयबाट',
    heroSupport:
      'हामी सिधै गाउँलेहरूबाट संकलन गर्छौं र स्थानीय उत्पादन प्रवर्द्धन गर्छौं — समुदायलाई सशक्त बनाउँदै परम्परा जोगाउँछौं।',
    exploreProducts: 'उत्पादन हेर्नुहोस्',
    talkWithUs: 'कुरा गर्नुहोस्',
    whatsapp: 'WhatsApp',
    valuesEyebrow: 'हाम्रो प्रतिबद्धता',
    valuesHeading: 'मानिस, प्रकृति र तपाईंका लागि राम्रो',
    valuesLead:
      'प्रत्येक पात, मह र मसलामा एउटै वाचा छ: निष्पक्ष व्यापार, शुद्ध गुणस्तर, वास्तविक प्रभाव।',
    valuePeopleTitle: 'मानिसका लागि राम्रो',
    valuePeopleText:
      'हामी सिधै गाउँलेहरूबाट संकलन गर्छौं, जीविकोपार्जनमा सहयोग गर्छौं र स्थानीय परम्परा जोगाउँछौं।',
    valueNatureTitle: 'प्रकृतिका लागि राम्रो',
    valueNatureText:
      'हिमाली परिदृश्य र मौसमको सम्मान गर्दै जैविक तथा निष्पक्ष स्रोतबाट ल्याइएका उत्पादन।',
    valueYouTitle: 'तपाईंका लागि राम्रो',
    valueYouText:
      'शुद्धता, स्वाद र दैनिक स्वास्थ्यका लागि छानिएका प्रामाणिक, उच्च गुणस्तरका उत्पादन।',
    productsEyebrow: 'हाम्रा प्रिमियम उत्पादन',
    productsHeading: 'हिमाली खजाना, इमानदारीपूर्वक',
    productsLead:
      'चिया बगानदेखि पहाडी रेजिनसम्म — स्थानीय समुदायसँग जोडिएका प्रामाणिक वस्तुहरू।',
    readMore: 'थप पढ्नुहोस्',
    moreTreasures: 'र थप स्थानीय खजाना',
    askWhatsapp: 'WhatsApp मा सोध्नुहोस्',
    close: 'बन्द',
    missionEyebrow: 'सिधै गाउँलेहरूबाट',
    missionHeading: 'इमानदार हृदयसहित निष्पक्ष व्यापार',
    missionLead:
      'हामी स्थानीय समुदायसँग सिधै काम गर्छौं — प्रामाणिक उत्पादन ल्याउँदै उनीहरूको जीविकोपार्जनलाई सहयोग गर्छौं।',
    contactEyebrow: 'नमस्कार',
    contactHeading: 'पोखरा आउनुहोस् — वा जुनसुकै बेला लेख्नुहोस्',
    contactLead:
      'उत्पादन, थोक वा स्वाद परीक्षणबारे जिज्ञासा? गाउँबाट आएका ताजा कुरा खुसीसाथ बाँड्छौं।',
    phone: 'फोन',
    email: 'इमेल',
